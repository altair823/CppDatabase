...
Result<bool> Record::set_field(std::shared_ptr<FieldData> data, const std::string& field_name) {
...
Result<FieldShared> Record::get_field(const std::string& field_name) const {
